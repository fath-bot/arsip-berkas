        ...
        <div class="footer py-4 d-flex flex-lg-column " id="kt_footer">
            ...
            <div class=" container  d-flex flex-column flex-md-row flex-stack">
                ...
                <div class="text-dark order-2 order-md-1">
                    <span class="text-black-400 fw-semibold me-2">Copyright &copy;
                        {{ Carbon\Carbon::now()->year }}</span>
                    <a href="https://www.bpkp.go.id/id" target="_blank"
                        class="text-black-400 text-muted text-hover-primary fw-semibold me-2 fs-6">Badan Pengawasan Keuangan dan
                        Pembangunan</a>
                </div>
                {{-- end::Copyright --}}
                {{-- begin::Menu --}}
