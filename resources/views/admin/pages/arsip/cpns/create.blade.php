        ...
        <div class=" container-xxl " id="kt_content_container">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    {{-- begin::Form --}}
                    <form class="form" action="{{ route('admin.cpnss.store') }}" method="POST"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                {{-- begin::Label --}}
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">No SK CPNS</label>
                                {{-- end::Label --}}
                                {{-- begin::Col --}}
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="no_sk"
                                        class="form-control form-control-lg form-control-solid @error('no_sk') is-invalid @enderror"
                                        placeholder="Tuliskan No SK CPNS" value="{{ old('no_sk') }}" />
                                    @error('no_sk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-6">
                                {{-- begin::Label --}}
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal SK CPNS</label>
                                {{-- end::Label --}}
                                {{-- begin::Col --}}
                                <div class="col-lg-8 fv-row">
                                    <input type="date" name="tanggal"
                                        class="form-control form-control-lg form-control-solid @error('tanggal') is-invalid @enderror"
                                        placeholder="Pilih Tanggal SK CPNS" value="{{ old('tanggal') }}" />
                                    @error('tanggal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
