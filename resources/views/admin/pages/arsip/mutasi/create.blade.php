...
@section('title')
    Tambah Data Arsip SK Mutasi Unit
@endsection
        ...
        <div class=" container-xxl " id="kt_content_container">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    {{-- begin::Form --}}
                    <form class="form" action="{{ route('admin.mutasis.store') }}" method="POST"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                {{-- begin::Label --}}
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">Tanggal SK Mutasi</label>
                                {{-- end::Label --}}
                                {{-- begin::Col --}}
                                <div class="col-lg-8 fv-row">
                                    <input type="date" name="tanggal"
                                        class="form-control form-control-lg form-control-solid @error('tanggal') is-invalid @enderror"
                                        placeholder="Pilih Tanggal SK Mutasi" value="{{ old('tanggal') }}" />
                                    @error('tanggal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
