        ...
        <div class=" container-xxl " id="kt_content_container">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_profile_details" class="collapse show">
                    {{-- begin::Form --}}
                    <form class="form" action="{{ route('admin.mutasis.update', $mutasis->id) }}" method="POST"
                        ...
                        {{-- end::Card body --}}
                            <div class="row mb-6">
                                {{-- begin::Label --}}
                                <label class="col-lg-4 col-form-label required fw-bold fs-6">No SK Mutasi Unit</label>
                                {{-- end::Label --}}
                                {{-- begin::Col --}}
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="no_sk"
                                        class="form-control form-control-lg form-control-solid @error('no_sk') is-invalid @enderror"
                                        placeholder="Tuliskan No SK Mutasi Unit" value="{{ old('no_sk') }}" />
                                    @error('no_sk')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                             ...
                             <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="date" name="tanggal"
                                        ...
                                        placeholder="Tuliskan Tanggal SK Mutasi Unit" value="{{ old('tanggal') }}" />
                                    @error('tanggal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
